import os
import fairseq.cometcommonsense.src.data.atomic as atomic_data
import fairseq.cometcommonsense.src.data.conceptnet as conceptnet_data
import fairseq.cometcommonsense.src.data.config as cfg

from fairseq.cometcommonsense.utils import utils
